...
namespace Chat
{
    ...
    public class ClientChatMessage : ChatMessage
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Creates a new <c>ClientChatMessage</c> with the given message ID, sender UUID, and message and sets the timestamp to now with a pending status.
        /// </summary>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Creates a new <c>ClientChatMessage</c> with the given message ID, sender UUID, message, and status and sets the timestamp to now.
        /// </summary>
        /// <param name="messageId">Unique message ID</param>
        /// <param name="senderUuid">Sender's UUID</param>
        /// <param name="message">Message</param>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Creates a new <c>ClientChatMessage</c> with the given message ID, sender UUID, message, and timestamp with a pending status.
        /// </summary>
        /// <param name="messageId">Unique message ID</param>
        /// <param name="senderUuid">Sender's UUID</param>
        /// <param name="message">Message</param>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Creates a new <c>ClientChatMessage</c> with the given message ID, sender UUID, message, timestamp, and status.
        /// </summary>
        /// <param name="messageId">Unique message ID</param>
        /// <param name="senderUuid">Sender's UUID</param>
        /// <param name="message">Message</param>
