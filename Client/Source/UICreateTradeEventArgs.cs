    ...
    public class UICreateTradeEventArgs : CreateTradeEventArgs
    {
        ...
        public static UICreateTradeEventArgs FromCreateTradeEventArgs(CreateTradeEventArgs args, ClientUserManager userManager)
        {
            if (args.Success)
            {
                ...
                return new UICreateTradeEventArgs(new ImmutableTrade(args.TradeId, otherParty, Array.Empty<ProtoThing>(), Array.Empty<ProtoPawn>(), Array.Empty<ProtoThing>(), Array.Empty<ProtoPawn>(), false, false));
            }
            else
            {
